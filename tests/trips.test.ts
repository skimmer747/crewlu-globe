...
const leg = (o: Partial<Leg>): Leg => ({
  id: 'x', from: 'SDF', to: 'ANC', s: [0, 0], e: [1, 1], t: 0, takeoff: 0, landing: 0, out: 0, in: 0, blockMs: 0, sched: { out: null, off: null, on: null, in: null }, act: { out: null, off: null, on: null, in: null }, dh: false, miles: 1, aircraft: null, tripId: null, ...o,
})
